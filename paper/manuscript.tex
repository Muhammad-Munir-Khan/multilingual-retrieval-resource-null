...
% the specific tool/vendor name. Moved out of Acknowledgment into its own
% titled section on 2026-09-18, matching the exact section title IJIMAI's
% Statement of Originality/COI/Rights-Assignment form requires (Section VI:
% "such use has been disclosed in a section entitled 'Declaration of AI
% Use'"). The specific tool remains named in docs/ai_use_log.md for the
% project's own record. "Executed by the author" is the author's own chosen
% phrasing; flagged to the author as a possible divergence from
% ai_use_log.md (which records the AI assistant as having executed the
% experiments under the author's direction) and kept as written at the
...
No further acknowledgments to declare.
